...
this will produce html like:
  ...
  <link type="text/css" media="screen" ref="stylesheet" href="/components/SexyButtons/sexybuttons.css" />
...
this will produce html like:
  ...
  <button class="sexybutton sexysimple sexyorange custom" id="sbtn-id" ref="sbtn" type="submit"><span class="ok">Simple Button</span></button>
